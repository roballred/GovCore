...
'@govcore/auth': patch
'@govcore/middleware': patch
'@govcore/server': patch
'@govcore/theme': patch
'@govcore/nextkit': patch
'@govcore/content': patch
'@govcore/support': patch
'@govcore/federation': patch
'@govcore/backup': patch
'@govcore/testing': patch
---

Ship compiled builds — retire source-first packaging (#71, closes #56).
