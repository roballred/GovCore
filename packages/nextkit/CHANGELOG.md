...
- 3b5a9a6: AppShell `fixed-rail`: reclaim the rail's width in print (#148)
...
- 411ae31: AppShell: fixed-rail layout, focusable `<main>`, and `mainProps` (#141)
...
- e3ebec1: AppShell: responsive mobile nav via a new `MobileNavDrawer` (#102 gap 2)
...
- 6a388f5: Fix branded GroupedSideNav group-header contrast (#135)
...
- 51a048b: AppShell: fluid width, skip-link + landmarks, print-clean chrome, header search slot (#102)
...
- 7340293: GroupedSideNav/SideNav: branded-rail tone, ungrouped top items, open-section DOM hook (#103)
